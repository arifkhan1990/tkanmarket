...
CREATE TABLE "auth_security_events" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "auth_security_events_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"user_id" integer,
	"email" text,
...
CREATE INDEX "audit_log_created_at_desc_idx" ON "audit_log" USING btree ("created_at" desc);--> statement-breakpoint
CREATE INDEX "auth_security_events_user_id_idx" ON "auth_security_events" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "auth_security_events_event_type_idx" ON "auth_security_events" USING btree ("event_type");--> statement-breakpoint
CREATE INDEX "auth_security_events_created_at_desc_idx" ON "auth_security_events" USING btree ("created_at" desc);--> statement-breakpoint
...
CREATE INDEX "notifications_created_at_desc_idx" ON "notifications" USING btree ("created_at" desc);--> statement-breakpoint
CREATE INDEX "api_keys_created_by_id_idx" ON "api_keys" USING btree ("created_by_id");--> statement-breakpoint
CREATE INDEX "api_keys_created_at_desc_idx" ON "api_keys" USING btree ("created_at" desc);