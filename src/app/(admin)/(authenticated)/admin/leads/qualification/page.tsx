...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: `${m.admin.leadScoringPage.tabQualification} | ${m.common.brand}`,
    description: m.admin.leadScoringPage.subtitle
  }
}

export default async function AdminLeadQualificationPage() {
  await requireAdminOrRedirect()
  return <LeadScoringSuiteClient initialTab="qualification" />
}
